...
export interface ExtendedPathWithParams<T extends string> extends Partial<Omit<NavigationPath, 'pathname'>> {
...
export interface RouteNavigator {
    push<T extends string>(to: NavigationTo | PageWithParams<T> | ExtendedPathWithParams<T>, params: Params<T>, options?: NavigationOptions): Promise<void>;
    push(to: NavigationTo | Page | ExtendedPath, options?: NavigationOptions): Promise<void>;
    replace<T extends string>(to: NavigationTo | PageWithParams<T>, params: Params<T>, options?: NavigationOptions): Promise<void>;
...
export type NavigationTarget = NavigationTo | PageWithParams<string> | Page | ExtendedPathWithParams<string> | ExtendedPath;
export {};
//# sourceMappingURL=RouteNavigator.type.d.ts.map