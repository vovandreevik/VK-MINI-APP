        ...
        switch (_a.label) {
          case 0:
            if (IS_ANDROID_WEBVIEW || IS_IOS_WEBVIEW) {
              return [2, supports(method)];
            }
            if (supportedHandlers) {
              return [2, supportedHandlers.includes(method)];
            }
            _a.label = 1;
          case 1:
            _a.trys.push([1, 3, , 4]);
            return [4, sendPromise("SetSupportedHandlers")];
          case 2:
            response = _a.sent();
...
(function(BannerAdHeightType2) {
  BannerAdHeightType2["COMPACT"] = "compact";
  BannerAdHeightType2["REGULAR"] = "regular";
})(BannerAdHeightType || (BannerAdHeightType = {}));
var BannerAdOrientation;
(function(BannerAdOrientation2) {
  BannerAdOrientation2["HORIZONTAL"] = "horizontal";
  BannerAdOrientation2["VERTICAL"] = "vertical";
...
//# sourceMappingURL=chunk-XJPSIHVC.js.map
